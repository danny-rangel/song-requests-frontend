...
module.exports = (_env, argv) => {
    let entryPoints = {
        // VideoComponent: {
        //     path: ['babel-polyfill', './src/VideoComponent.js'],
        //     outputHtml: 'video_component.html',
        //     build: true
        // },
        // VideoOverlay: {
        //     path: ['babel-polyfill', './src/VideoOverlay.js'],
        //     outputHtml: 'video_overlay.html',
        //     build: true
        // },
        Panel: {
            path: ['babel-polyfill', './src/Panel.js'],
            outputHtml: 'panel.html',
            build: true
        },
        Config: {
            path: ['babel-polyfill', './src/Config.js'],
            outputHtml: 'config.html',
            build: true
        },
        LiveConfig: {
            path: ['babel-polyfill', './src/LiveConfig.js'],
            outputHtml: 'live_config.html',
            build: true
        }
        // Mobile: {
        //     path: ['babel-polyfill', './src/Mobile.js'],
